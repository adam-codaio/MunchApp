...
//  Munch
//
//  Created by Adam Ginzberg on 11/14/15.
...
//        dataHelper.printAllUserClaims()
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "edu.stanford.cs193p.ginzberg.Munch" in the application's documents Application Support directory.
